(function ($, core, undefined) {
    ...
    nethelp.toc.prototype.options.itemTemplate = '<li id="#{id}" data-icon="#{icon}" class="#{itemClass}"><a href="#{this.url || \'javascript:void(0)\'}" <#if(this.target){#> target="#{target}" <#}#> title="#{tooltip}" class="inner c1-toc-text">#{title}' +
            '</a>#{subtree}</li>';
